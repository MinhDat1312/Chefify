                ...
                <Col className="d-flex justify-content-start px-0" md={7}>
                    ...
                    >
                        ...
                        <div className="d-flex flex-column gap-2">
                            ...
                            <p className="my-0">
                                Pick over and hull strawberries. Cut in half or slice, depending on size. Gently crush
                                about a quarter of the berries with a fork to release their juices. Mix with remaining
                                berries and the ½ cup of sugar, adding more sugar if necessary. Set aside, covered, for
                                about half an hour to develop flavor.
                            </p>
                        ...
                        <div className="d-flex flex-column gap-2">
                            ...
                            <p className="my-0">
                                ...
                                powder. Add ¾ cup of softened butter, and rub into dry ingredients as for pastry. Add 1¼
                                cups cream, and mix to a soft dough. Knead the dough for one minute on a lightly floured
                                pastry board, then roll it out to about ½-inch thickness. Using a 3-inch biscuit cutter,
                                cut an even number of rounds - 2 rounds per serving.
                            </p>
                        ...
                        <div className="d-flex flex-column gap-2">
                            ...
                            <p className="my-0">
                                ...
                                remaining butter and brush a little on the rounds; place remaining rounds on top. Bake
